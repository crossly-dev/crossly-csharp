# net.crossly.buyer.Model.GetSpatialPublicResponseProfile
...
**DefaultGroupBy** | **List&lt;string&gt;** | Default grouping, in order. Each level becomes a divider or a container. | 
**DefaultSortBy** | **List&lt;string&gt;** | Default ordering inside a group. | 
