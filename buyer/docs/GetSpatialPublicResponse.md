# net.crossly.buyer.Model.GetSpatialPublicResponse
...
**Items** | [**List&lt;GetSpatialPublicResponseItems&gt;**](GetSpatialPublicResponseItems.md) | Enough to draw an object and label it. No cost, no location, no status. | 
