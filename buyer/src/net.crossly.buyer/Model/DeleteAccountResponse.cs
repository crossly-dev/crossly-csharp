...
namespace net.crossly.buyer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteAccountResponse")]
    public partial class DeleteAccountResponse : IEquatable<DeleteAccountResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAccountResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteAccountResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAccountResponse" /> class.
        /// </summary>
        /// <param name="ok">ok (required).</param>
        public DeleteAccountResponse(bool ok = default(bool))
        {
            this.Ok = ok;
        }
        ...
        /// <summary>
        /// Returns true if DeleteAccountResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteAccountResponse to be compared</param>
        /// <returns>Boolean</returns>
