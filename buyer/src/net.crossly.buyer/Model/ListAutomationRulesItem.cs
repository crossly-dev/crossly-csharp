...
namespace net.crossly.buyer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAutomationRulesItem")]
    public partial class ListAutomationRulesItem : IEquatable<ListAutomationRulesItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAutomationRulesItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListAutomationRulesItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAutomationRulesItem" /> class.
        /// </summary>
        ...
        public ListAutomationRulesItem(string id = default(string), string name = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string userId = default(string), bool isActive = default(bool), List<string> platforms = default(List<string>), string triggerType = default(string), string conditionType = default(string), string actionType = default(string), DateTime? lastRunAt = default(DateTime?), DateTime? nextRunAt = default(DateTime?), decimal runCount = default(decimal))
        {
            ...
            if (userId == null) {
                throw new ArgumentNullException("userId is a required property for ListAutomationRulesItem and cannot be null");
            }
            this.UserId = userId;
            this.IsActive = isActive;
            // to ensure "triggerType" is required (not null)
            if (triggerType == null) {
                throw new ArgumentNullException("triggerType is a required property for ListAutomationRulesItem and cannot be null");
            }
            this.TriggerType = triggerType;
            // to ensure "actionType" is required (not null)
            if (actionType == null) {
                throw new ArgumentNullException("actionType is a required property for ListAutomationRulesItem and cannot be null");
            }
        ...
        {
            return this.Equals(input as ListAutomationRulesItem);
        }

        /// <summary>
        /// Returns true if ListAutomationRulesItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAutomationRulesItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAutomationRulesItem input)
        {
            if (input == null)
            {
                return false;
