...
namespace net.crossly.buyer.Model
{
    ...
    public partial class CreateConnectionRequestResponse : IEquatable<CreateConnectionRequestResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateConnectionRequestResponse(bool ok = default(bool))
        {
            this.Ok = ok;
        }
        ...
        {
            return this.Equals(input as CreateConnectionRequestResponse);
        }

        /// <summary>
        /// Returns true if CreateConnectionRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateConnectionRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateConnectionRequestResponse input)
        {
            if (input == null)
            {
                return false;
