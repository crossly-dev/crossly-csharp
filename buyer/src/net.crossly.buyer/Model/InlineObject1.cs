...
namespace net.crossly.buyer.Model
{
    ...
    public partial class InlineObject1 : IEquatable<InlineObject1>, IValidatableObject
    {
        ...
        public InlineObject1(string listingSlug = default(string))
        {
            // to ensure "listingSlug" is required (not null)
            if (listingSlug == null) {
                throw new ArgumentNullException("listingSlug is a required property for InlineObject1 and cannot be null");
            }
